...
const baseTask: EnrichedTask = {
  ...
  dependsOn: [],
  notes: '',
  blockedByTasks: [{ ...BLANK_DATES, id: 'T1', name: 'Design mockups', project: 'Alpha', description: '', assignee: 'Alice', storyPoints: 0, status: 'Done', startDate: '2026-06-01', endDate: '2026-06-05', blockedBy: [], dependsOn: [], notes: '' }],
  blocksTasks: [{ ...BLANK_DATES, id: 'T3', name: 'Write tests', project: 'Alpha', description: '', assignee: 'Carol', storyPoints: 0, status: 'Todo', startDate: '2026-06-10', endDate: '2026-06-20', blockedBy: ['T1', 'T2'], dependsOn: [], notes: '' }],
  dependsOnTasks: [],
  dependedOnByTasks: [],
}
